...
//
//public class InsideActivity_first_1_bak extends AppCompatActivity {
//
//    @Override
...
//        //subway_car3_button.setBackgroundResource(context.getResources().getColor(R.color.train_yellow);
//        //subway_car4_button.setBackgroundResource(Color.parseColor(getString(R.drawable.train_red)));
//
//        //텍스트 변경
////        station_name.setText("2호선");
//        where.setText("다대포해수욕장행");
//        locate.setText(DetailActivity_first.title);
