...
class ThreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _three_to_first_list = MainActivity.second_three_to_first_list
        _three_to_second_list = MainActivity.second_three_to_second_list
        _three_to_third_list = MainActivity.second_three_to_third_list
        _three_to_fourth_list = MainActivity.second_three_to_fourth_list
