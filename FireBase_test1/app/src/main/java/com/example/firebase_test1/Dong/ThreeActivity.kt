...
class ThreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dong_three)
        val button = findViewById<Button>(R.id.back)
        button.setOnClickListener { finish() }
        _move = MainActivity.dong_move
        _three_to_first_list = MainActivity.dong_three_to_first_list
        _three_to_second_list = MainActivity.dong_three_to_second_list
        _three_to_third_list = MainActivity.dong_three_to_third_list
        _three_to_fourth_list = MainActivity.dong_three_to_fourth_list
