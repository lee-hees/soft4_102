...
class ThreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kim_three)
        val button = findViewById<Button>(R.id.back)
        button.setOnClickListener { finish() }
        _move = MainActivity.kim_move
        _three_to_first_list = MainActivity.kim_three_to_first_list
        _three_to_second_list = MainActivity.kim_three_to_second_list
        _three_to_third_list = MainActivity.kim_three_to_third_list
        _three_to_fourth_list = MainActivity.kim_three_to_fourth_list
