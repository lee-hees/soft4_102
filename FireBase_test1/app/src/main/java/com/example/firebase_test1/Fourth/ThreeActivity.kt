...
class ThreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fourth_three)
        val button = findViewById<Button>(R.id.back)
        button.setOnClickListener { finish() }
        _move = MainActivity.fourth_move
        _three_to_first_list = MainActivity.fourth_three_to_first_list
        _three_to_second_list = MainActivity.fourth_three_to_second_list
        _three_to_third_list = MainActivity.fourth_three_to_third_list
        _three_to_fourth_list = MainActivity.fourth_three_to_fourth_list
